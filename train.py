...
if __name__ == '__main__':
    ...
    train_data = pandora.utils.load_annotated_file(
        'data/capitula_classic/train0.tsv',
        format='tab',
    ...
    dev_data = pandora.utils.load_annotated_file(
        'data/capitula_classic/test0.tsv',
        format='tab',
        include_pos=params['include_pos'],
        include_lemma=params['include_lemma'],
        include_morph=params['include_morph'],
    ...
    # test_data = pandora.utils.load_annotated_file(
    #     'data/capitula_classic/test0.tsv',
    # dev_data = pandora.utils.load_annotated_file(
    #     'data/mdu/cg-lit/cg-lit_dev.tab',
    # dev_data = pandora.utils.load_annotated_file('data/EMDu/train.txt',
    # test_data = pandora.utils.load_annotated_file(
    #     'data/mdu/cg-lit/cg-lit_test.tab',
    #     format='tab',
    #     include_pos=params['include_pos'],
    #     include_lemma=params['include_lemma'],
    #     include_morph=params['include_morph'],
    ...
    # tagger.save()
    # tagger = Tagger(load=True, model_dir='models/12c_x')
